  ...
  public static void createPlayer(String uuid) {
    if (Config.config.getBoolean("mysql.support")) {
      if (!playerExists(uuid)) {
        ...
        MYSQL.update("INSERT INTO `kit_archer`(`uuid`) VALUES ('" + uuid + "')");
        MYSQL.update("INSERT INTO `kit_default`(`uuid`) VALUES ('" + uuid + "')");
        MYSQL.update("INSERT INTO `kit_fisher`(`uuid`) VALUES ('" + uuid + "')");
      }
    }
  }
