...
import commands.Kit;
import commands.SetArenaheight;
import commands.SetDeathheight;
import commands.SetSpawn;
import commands.SetStartmap;
import commands.Stats;
import commands.Teaming;
...
public class Main extends JavaPlugin {
  ...
  public void loadCommands(){
    ...
    getCommand("kit").setExecutor((CommandExecutor)new Kit());
